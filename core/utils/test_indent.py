...
from core.utils.indent_utils import (
    IndentType,
    apply_indent_type,
    detect_indent_type,
    detect_line_indent,
...
\treturn result"""
    ...
    def test_detect_indent_type_edge_cases(self):
        ...
        assert (
            indent_type.most_used
            == IndentType.tab()  # pyright: ignore[reportOptionalMemberAccess]
