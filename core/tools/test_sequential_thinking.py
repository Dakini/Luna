...
class TestSequentialThinkingTool(unittest.TestCase):
    ...
    def test_validate_thought_data_valid(self):
        ...
        self.assertEqual(
            result["thought"], "This is a test thought"
        )  # pyright: ignore[reportTypedDictNotRequiredAccess]
        self.assertEqual(
            result["thoughtNumber"], 1
        )  # pyright: ignore[reportTypedDictNotRequiredAccess]
        self.assertEqual(
            result["totalThoughts"], 5
        )  # pyright: ignore[reportTypedDictNotRequiredAccess]
        self.assertTrue(
    ...
    def test_format_thought_regular(self):
        ...
        formatted = self.tool._format_thought(
            thought_data
    ...
    def test_adjust_total_thoughts(self):
        ...
        self.assertEqual(
            self.tool.thought_history[0]["totalThoughts"], 10
        )  # pyright: ignore[reportTypedDictNotRequiredAccess]
