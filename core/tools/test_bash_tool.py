...
def test_successful_command():
    ...
    with patch("core.tools.bash_tool.run_command") as mock_run_command:
...
class BashToolTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.start_shell_patch = patch(
            "core.tools.bash_tool.start_persistent_shell",
            return_value=(self.mock_child, self.mock_prompt),
        )
        self.run_command_patch = patch(
            "core.tools.bash_tool.run_command",
    ...
    def test_create_bash_tool(self):
        ...
        with patch("core.tools.bash_tool.BashTool") as mock_bash_tool:
            _ = create_bash_tool(
...
class StartPersistentShellTest(unittest.TestCase):
    ...
    @patch("core.tools.bash_tool.pexpect.spawn")
